<?php
/**
 * admin/bookings.php — review and act on booking requests.
 */
...
$bookings = get_bookings_for_review($statusFilter);

$_SESSION['csrf_token'] = bin2hex(random_bytes(32));
$csrf_token = $_SESSION['csrf_token'];

$filters = ['pending' => 'Pending', 'approved' => 'Approved', 'waitlist' => 'Waitlist', 'rejected' => 'Rejected', 'cancelled' => 'Cancelled', 'all' => 'All'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Booking Requests — SURAS Admin</title>
  ...
  <div class="container">
    ...
    <div class="page-head">
      <div>
        ...
        <p>Sorted by priority score, then by who asked first.</p>
      </div>
    </div>
    ...
    <div class="chip-group" style="margin-bottom: 24px;">
      <?php foreach ($filters as $key => $label): ?>
        <a class="chip <?php echo $statusFilter === $key ? 'is-active' : ''; ?>" href="bookings.php?status=<?php echo e($key); ?>"><?php echo e($label); ?></a>
      <?php endforeach; ?>
    </div>
    ...
    <?php else: ?>
      <table class="data-table">
        <thead>
          <tr><th>Requester</th><th>Resource</th><th>When</th><th>Priority</th><th>Status</th><th></th></tr>
        </thead>
        <tbody>
          <?php foreach ($bookings as $b): ?>
            <tr>
              ...
              <td>
                ...
                <div class="resource-sub"><?php echo e(category_label($b['resource_category'])); ?> · <?php echo e($b['purpose']); ?></div>
              </td>
              <td>
              ...
              <td style="white-space:nowrap;">
                <?php if (in_array($b['status'], ['pending', 'waitlist'], true)): ?>
                  ...
                  <form method="POST" action="bookings.php" style="display:inline;" onsubmit="return confirm('Reject this booking?');">
                    <input type="hidden" name="csrf_token" value="<?php echo e($csrf_token); ?>">
